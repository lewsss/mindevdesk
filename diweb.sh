...
## GPL,Written By MoeClub.org and linux-live.org,moded by minlearn (https://gitee.com/minlearn/mindevdesk/) for mindevdesk remastering and installing (both local install and cloud dd) purposes and for onedrive mirror/image hosting.
## meant to work/tested under linux and osx with bash > 4
## usage: ci.sh [[-b 0 ] -h 0] -t mindevdesk|debianbase
...
#export custDEBMIRROR1='https://github.com/minlearn/mindevdesk/raw/master'
export custDEBMIRROR1='https://gitee.com/minlearn/mindevdesk/raw/master'

#export custIMGMIRROR1='https://github.com/minlearn/mindevdesk/raw/master'
export custIMGMIRROR1='https://gitee.com/minlearn/mindevdesk/raw/master'
...
export GENAPPS='0' #0:owt+dpi,1:owt+dsm,2:owt+dsm+linux1h/2g/64g,3:owt+win2h4g/128g,4:owt+osx2h4g/128g only5:all 0,1,2,3,4
export PACKAPPPS='n'
    ...
    -t|--target)
      ...
      case $tmpTARGET in
        ...
        mindevdesk) 
          ...
          [[ "$tmpTARGETMODE" != '1' ]] && echo "instonly mode detected" && tmpTARGETDDURL=$custIMGMIRROR1/_build/mindevdesk/mindevdesk_
          [[ "$tmpTARGETMODE" == '1' ]] && echo "fullgen mode detected" && tmpTARGETDDURL=$custIMGMIRROR1/_build/mindevdesk/mindevdesk_ ;;
...
preparepreseed(){
  ...
  [[ "$UNZIP" == '1' && "$tmpTARGET" != 'mindevdesk' ]] && PIPECMDSTR='wget -qO- '$tmpTARGETDDURL' |tar zOx |dd of=$(list-devices disk |head -n1) bs=10M status=progress';
  [[ "$UNZIP" == '2' ]] && PIPECMDSTR='wget -qO- '$tmpTARGETDDURL' |gunzip -dc |dd of=$(list-devices disk |head -n1) bs=10M status=progress';
  [[ "$tmpTARGET" == 'mindevdesk' ]] && PIPECMDSTR='(for i in `seq -w 0 999`;do wget -qO- --no-check-certificate '$tmpTARGETDDURL'$i; done)|tar zOx |dd of=$(list-devices disk |head -n1) bs=10M status=progress';
...
patchinitrd(){
  ...
  for i in dbus_1.12.20-0-deb10u1_amd64.deb libdbus-1-3_1.12.20-0-deb10u1_amd64.deb libexpat1_2.2.6-2-deb10u1_amd64.deb; do
    [[ "$tmpTARGETMODE" == '0' ]] && [[ ! -f $topdir/$downdir/debianbase/dists/buster/main/binary-amd64/deb/$i || ! -s $topdir/$downdir/debianbase/dists/buster/main/binary-amd64/deb/$i ]] && wget -qO- --no-check-certificate $MIRROR/_build/debianbase/dists/buster/main/binary-amd64/deb/$i > $topdir/$downdir/debianbase/dists/buster/main/binary-amd64/deb/$i && [[ $? -ne '0' ]] && echo "download failed" && exit 1
    [[ "$tmpTARGETMODE" == '1' ]] && [[ ! -f $topdir/$downdir/debianbase/dists/buster/main/binary-amd64/deb/$i ]] && cp $topdir/_build/debianbase/dists/buster/main/binary-amd64/deb/$i $topdir/$downdir/debianbase/dists/buster/main/binary-amd64/deb/$i && [[ $? -ne '0' ]] && echo "copy failed" && exit 1
  done

  mkdir -p $chrootdir/tools
  cp $topdir/$downdir/debianbase/dists/buster/main/binary-amd64/deb/{dbus_1.12.20-0-deb10u1_amd64.deb,libdbus-1-3_1.12.20-0-deb10u1_amd64.deb,libexpat1_2.2.6-2-deb10u1_amd64.deb} $chrootdir/tools/
  chroot $chrootdir sh -c "dpkg -iR /tools >/dev/null 2>&1; rm -rf /tools"

  chroot $chrootdir sh -c "echo 'root:tdl' | chpasswd root;echo 'tdl:tdl' | chpasswd root; echo 'tdl ALL=(ALL) ALL' >> /etc/sudoers"
  ...
  [[ "$tmpHOST" == '1' && "$tmpHOSTMODEL" == 'mbp' ]] && {
    ...
    for i in firmware-brcm80211_20190114-2_all.deb libnl-3-200_3.4.0-1_amd64.deb libnl-genl-3-200_3.4.0-1_amd64.deb iw_5.0.1-1_amd64.deb libpcsclite1_1.8.24-1_amd64.deb libnl-route-3-200_3.4.0-1_amd64.deb readline-common_7.0-5_all.deb libreadline7_7.0-5_amd64.deb wpasupplicant_2.7-git20190128-0c1e29f-6-deb10u2_amd64.deb lsb-base_10.2019051400_all.deb dhcpcd5_7.1.0-2_amd64.deb psmisc_23.2-1_amd64.deb laptop-mode-tools_1.72-3_all.deb; do 
      ...
      [[ "$tmpTARGETMODE" == '0' ]] && [[ "$i" != 'firmware-brcm80211_20190114-2_all.deb' || "$i" != 'wpasupplicant_2.7-git20190128-0c1e29f-6-deb10u2_amd64.deb' ]] && [[ ! -f $topdir/$downdir/debianbase/dists/buster/main/binary-amd64/deb/$i || ! -s $topdir/$downdir/debianbase/dists/buster/main/binary-amd64/deb/$i ]] && wget -qO- --no-check-certificate $MIRROR/_build/debianbase/dists/buster/main/binary-amd64/deb/$i > $topdir/$downdir/debianbase/dists/buster/main/binary-amd64/deb/$i && [[ $? -ne '0' ]] && echo "download failed" && exit 1
      [[ "$tmpTARGETMODE" == '0' ]] && [[ "$i" == 'firmware-brcm80211_20190114-2_all.deb' ]] && [[ ! -f $topdir/$downdir/debianbase/dists/buster/main/binary-amd64/deb/$i || ! -s $topdir/$downdir/debianbase/dists/buster/main/binary-amd64/deb/$i ]] && (for ii in 000 001 002 003 004;do wget -qO- --no-check-certificate $MIRROR/_build/debianbase/dists/buster/main/binary-amd64/deb/$i$ii; done) > $topdir/$downdir/debianbase/dists/buster/main/binary-amd64/deb/$i && [[ $? -ne '0' ]] && echo "download failed" && exit 1
      [[ "$tmpTARGETMODE" == '0' ]] && [[ "$i" == 'wpasupplicant_2.7-git20190128-0c1e29f-6-deb10u2_amd64.deb' ]] && [[ ! -f $topdir/$downdir/debianbase/dists/buster/main/binary-amd64/deb/$i || ! -s $topdir/$downdir/debianbase/dists/buster/main/binary-amd64/deb/$i ]] && (for ii in 000 001;do wget -qO- --no-check-certificate $MIRROR/_build/debianbase/dists/buster/main/binary-amd64/deb/$i$ii; done) > $topdir/$downdir/debianbase/dists/buster/main/binary-amd64/deb/$i && [[ $? -ne '0' ]] && echo "download failed" && exit 1

      [[ "$tmpTARGETMODE" == '1' ]] && [[ "$i" != 'firmware-brcm80211_20190114-2_all.deb' || "$i" != 'wpasupplicant_2.7-git20190128-0c1e29f-6-deb10u2_amd64.deb' ]] && [[ ! -f $topdir/$downdir/debianbase/dists/buster/main/binary-amd64/deb/$i ]] && cp $topdir/_build/debianbase/dists/buster/main/binary-amd64/deb/$i $topdir/$downdir/debianbase/dists/buster/main/binary-amd64/deb/$i && [[ $? -ne '0' ]] && echo "copy failed" && exit 1
      [[ "$tmpTARGETMODE" == '1' ]] && [[ "$i" == 'firmware-brcm80211_20190114-2_all.deb' || "$i" == 'wpasupplicant_2.7-git20190128-0c1e29f-6-deb10u2_amd64.deb' ]] && [[ ! -f $topdir/$downdir/debianbase/dists/buster/main/binary-amd64/deb/$i ]] && cat $topdir/_build/debianbase/dists/buster/main/binary-amd64/deb/$i* > $topdir/$downdir/debianbase/dists/buster/main/binary-amd64/deb/$i && [[ $? -ne '0' ]] && echo "cat failed" && exit 1

    done

    mkdir -p $chrootdir/firmware
    cp $topdir/$downdir/debianbase/dists/buster/main-non-free/binary-amd64/deb/firmware-brcm80211_20190114-2_all.deb $chrootdir/firmware/firmware-brcm80211_20190114-2_all.deb
    ...
    mkdir -p $chrootdir/tools
    cp $topdir/$downdir/debianbase/dists/buster/main/binary-amd64/deb/{libnl-3-200_3.4.0-1_amd64.deb,libnl-genl-3-200_3.4.0-1_amd64.deb,iw_5.0.1-1_amd64.deb,libpcsclite1_1.8.24-1_amd64.deb,libdbus-1-3_1.12.20-0-deb10u1_amd64.deb,libnl-route-3-200_3.4.0-1_amd64.deb,readline-common_7.0-5_all.deb,libreadline7_7.0-5_amd64.deb,wpasupplicant_2.7-git20190128-0c1e29f-6-deb10u2_amd64.deb} $chrootdir/tools
    cp $topdir/$downdir/debianbase/dists/buster/main/binary-amd64/deb/{lsb-base_10.2019051400_all.deb,dhcpcd5_7.1.0-2_amd64.deb} $chrootdir/tools
    cp $topdir/$downdir/debianbase/dists/buster/main/binary-amd64/deb/{psmisc_23.2-1_amd64.deb,laptop-mode-tools_1.72-3_all.deb} $chrootdir/tools
...
# . p/diweb/builder/99.fakeprogress.sh
...
echo -en "\n - Checking TARGET ......."
[[ "$tmpTARGETMODE" == '0' && "$tmpTARGET" != 'mindevdesk' ]] && CheckTarget $tmpTARGETDDURL || echo -en "[ \033[32m genmode,skipping!! \033[0m ]"
...
mkdir -p $downdir $topdir/p/diweb/tdl $downdir/debianbase/dists/buster/main/binary-amd64/deb
